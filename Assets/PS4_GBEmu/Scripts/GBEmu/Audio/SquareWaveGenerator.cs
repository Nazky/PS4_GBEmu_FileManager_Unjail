...
namespace UnityGB
{
	public class SquareWaveGenerator
	{
		...
		public float generalFrequency= 131072.0f;
		public float baseFrequency = 2048.0f;
		...
		public void SetFrequency(int gbFrequency)
		{
			try
			{
				float frequency = generalFrequency / baseFrequency;

				if (gbFrequency != baseFrequency)
				{
					frequency = (generalFrequency / (float)(baseFrequency - gbFrequency));
				}
